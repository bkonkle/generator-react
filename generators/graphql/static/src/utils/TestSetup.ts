...
const dbUrl = process.env.DATABASE_URL || 'postgres://cf-root@localhost:5432/communityfunded'
...
class MockFile implements MockFile {
  constructor (parts: MockFile['parts'], filename: MockFile['filename'], properties: MockFile['properties']) {
